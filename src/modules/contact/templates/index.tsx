            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Link className="text-slate-700 hover:text-teal-900  underline-offset-2" href="#">
				  info@testingAI.com
                  </Link>
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4 mt-12">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    className="mt-1 block w-full rounded-md border-slate-500 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                    id="name"
                    name="name"
                    type="text"
                  />
