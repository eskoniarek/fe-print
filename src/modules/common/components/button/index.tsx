...
const Button = ({
  ...
  return (
    <button
      {...props}
      className={clsx(
        "inline-flex rounded-md w-fit uppercase items-center justify-center min-h-[50px] px-5 py-[10px] text-small-regular border transition-colors duration-200 disabled:opacity-50",
