        ...
        <>
            ...
            <main className="bg-gray-100 py-12">
                <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    ...
                    <p>This Privacy Policy describes how Demo (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from Demo.shop (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
                    ...
                    <h2>Contact</h2>
                    <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at support@Demo.shop.</p>
                </div>
            </main>
            <Footer />
        </>
