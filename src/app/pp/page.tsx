        ...
        <>
            ...
            <main className="bg-gray-100 py-12">
                <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    ...
                    <p>This Privacy Policy describes how Printinc (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from Printinc.shop (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
                    ...
                    <ul>
                        <li>Companies who support our Site and Services, such as Medusa.js.</li>
                    ...
                    <h2>Cookies</h2>
                    <p>Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with, see. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
                    ...
                    <table className="min-w-full bg-white mt-6 rounded-lg overflow-hidden">
                        <thead className="bg-gray-200">
                            <tr>
                                <th className="w-1/2 px-6 py-3 text-left">Category</th>
                                <th className="w-1/2 px-6 py-3 text-left">Categories of Recipients</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="border-t">
                                <td className="px-6 py-4">Identifiers such as basic contact details and certain order and account information</td>
                                <td className="px-6 py-4">Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)<br />Business and marketing partners<br />Affiliates</td>
                            </tr>
                            <tr className="border-t">
                                <td className="px-6 py-4">Commercial information such as order information, shopping information and customer support information</td>
                                <td className="px-6 py-4">Internet or other similar network activity, such as Usage Data</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <p>We will not discriminate against you for exercising any of these rights. We may need to collect information from you to verify your identity, such as your email address or account information, before providing a substantive response to the request. In accordance with applicable laws, You may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them to act on your behalf, and we may need you to verify your identity directly.</p>
                    <h2>Complaints</h2>
                    ...
                    <h2>Contact</h2>
                    <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at support@Printinc.shop.</p>
                </div>
            </main>
            <Footer />
        </>
